...
import (
	...
	tableacl "vitess.io/vitess/go/vt/proto/tableacl"
...
type Session struct {
	...
	TableAclConfig       *tableacl.Config `protobuf:"bytes,25,opt,name=table_acl_config,json=tableAclConfig,proto3" json:"table_acl_config,omitempty"`
}
...
func (x *Session) GetTableAclConfig() *tableacl.Config {
	if x != nil {
		return x.TableAclConfig
	}
	return nil
}
...
var file_vtgate_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x0e, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x61, 0x63, 0x6c, 0x2e,
	...
	0x74, 0x6f, 0x22, 0xb7, 0x0d, 0x0a, 0x07, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x25,
	...
	0x61, 0x64, 0x76, 0x69, 0x73, 0x6f, 0x72, 0x79, 0x4c, 0x6f, 0x63, 0x6b, 0x12, 0x3a, 0x0a, 0x10,
	0x74, 0x61, 0x62, 0x6c, 0x65, 0x5f, 0x61, 0x63, 0x6c, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	0x18, 0x19, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x61, 0x63,
	0x6c, 0x2e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x52, 0x0e, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x41,
	0x63, 0x6c, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x1a, 0xd8, 0x01, 0x0a, 0x0c, 0x53, 0x68, 0x61,
...
var file_vtgate_proto_goTypes = []interface{}{
	...
	(*tableacl.Config)(nil),            // 25: tableacl.Config
...
var file_vtgate_proto_depIdxs = []int32{
	...
	25, // 11: vtgate.Session.table_acl_config:type_name -> tableacl.Config
	...
	12, // 33: vtgate.VStreamRequest.flags:type_name -> vtgate.VStreamFlags
